...
[cbaldene@lxplus933 python]$ 
[cbaldene@lxplus933 python]$ 
[cbaldene@lxplus933 python]$ 
[cbaldene@lxplus933 python]$ cat Herwig7
Herwig7_dimuon.py                               Herwig7.py                                      
Herwig7_Matchbox_aMCatNLO_Herwig_ppTojj_cff.py  Herwig7Settings/                                
[cbaldene@lxplus933 python]$ cat Herwig7.py
import FWCore.ParameterSet.Config as cms
